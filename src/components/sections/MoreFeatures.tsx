...
export default function MoreFeats() {
    ...
    return (
        <div ref={featsRef} className={`flex flex-col min-h-screen items-center justify-center gap-3 px-4 sm:px-6 ${isVisible ? "fade-in-up" : "opacity-0"}`}>
            <h1  className={`${playfair.className} text-3xl sm:text-4xl font-bold text-[#333333] text-center`}>More Amazing Features</h1>
            ...
            <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 w-full max-w-[350px] md:max-w-[700px] lg:max-w-[900px]`}>
                <div className={`${cards} flex items-center justify-center text-center flex-col gap-3 w-full py-7`}>
