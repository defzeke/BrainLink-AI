...
export default function Benefits() {
    ...
    return (
        <div
            ref={sectionRef}
            className={`flex flex-col min-h-screen items-center justify-center -mt-10 gap-3${visible ? ' fade-in-up' : ''}`}
        >
            <h1 className={`${playfair.className} text-4xl font-bold text-[#333333]`}>Why Choose BrainLink?</h1>
